...
<!-- start main -->
 			...
 			<!---//End-da-slider----->
            <div class="copyrights">Collect from <a href="http://www.js-css.cn/"  title="企业网站模板">企业网站模板</a></div>
 </div>
 <a  href="#services" class="button scroll"><img src="img/index/arrow.png"></a>	
 	<!-- start header -->
 	<div class="header">
 		<div class="logo">
 			<a  href="#s7" class="scroll"><img src="img/index/logo.png"></a>
 		</div>
		<!-- start top-nav-->
		<div class="h_right">	
		<div class="subMenu" >
     ...
     <div class="services sTop" id="services">
		  	<div class="wrap">
				...
				<div class="col_1_of_3 span_1_of_3">
					<img src="img/index/service1.png" alt="">
					<h4><a href="#">PIXEL PERFECT</a></h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					<p><a href="#">MORE</a></p>
				</div>
				<div class="col_1_of_3 span_1_of_3">
					<img src="img/index/service2.png" alt="">
					<h4><a href="#">CREATIVE DESIGN</a></h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					<p><a href="#">MORE</a></p>
				</div>
				<div class="col_1_of_3 span_1_of_3">
					<img src="img/index/service3.png" alt="">
		 ...
		 <div class="container"><!-- start container -->		 
	       <!-- start h_menu -->
			...
			<!-- end smart_nav * -->
						...
						<div id="portfoliolist">
							<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
								<div class="portfolio-wrapper">
									<a href="img/index/port.jpg #small-dialog1" class="flipLightBox popup-with-zoom-anim"><img src="img/index/port.jpg" alt="Image 2" style="top: 0px;"> </a>
									
								</div>
							</div>						
							<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
								<div class="portfolio-wrapper">
									<a href="img/index/port1.jpg #small-dialog1" class="flipLightBox popup-with-zoom-anim"><img src="img/index/port1.jpg" alt="Image 2" style="top: 0px;"> </a>								
								</div>
							</div>
							<div class="portfolio web mix_all" data-cat="web" style="display: inline-block; opacity: 1;">
								<div class="portfolio-wrapper">
									<a href="img/index/port2.jpg #small-dialog1" class="flipLightBox popup-with-zoom-anim"><img src="img/index/port2.jpg" alt="Image 2" style="top: 0px;"> </a>							
								</div>
							</div>
							<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
								<div class="portfolio-wrapper">
									<a href="img/index/port3.jpg #small-dialog1" class="flipLightBox popup-with-zoom-anim"><img src="img/index/port3.jpg" alt="Image 2" style="top: 0px;"> </a>
									
								</div>
							</div>
							<div class="portfolio web mix_all" data-cat="web" style="display: inline-block; opacity: 1;">
								<div class="portfolio-wrapper">
									<a href="img/index/port4.jpg #small-dialog1" class="flipLightBox popup-with-zoom-anim"><img src="img/index/port4.jpg" alt="Image 2" style="top: 0px;"> </a>
									
								</div>
							</div>
							<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
								<div class="portfolio-wrapper">
									<a href="img/index/port5.jpg #small-dialog1" class="flipLightBox popup-with-zoom-anim"><img src="img/index/port5.jpg" alt="Image 5" style="top: 0px;"> </a>
						...
						<div class="img">
							<a href="#"><img src="img/index/zoom.png" alt=""></a>	
						</div>						
			</div><!-- end container -->
		</div>
  <!----start-team-members---->
					...
					<div class="wrap"> 
						...
						<div class="tm-head-grids">
							<div class="tm-head-grid">
								<img src="img/index/team-member1.jpg" alt="" />
								<h4>JOHNNY BEAR</h4>
								<h5>CEO, Founder</h5>
							...
							<div class="tm-head-grid">
								<img src="img/index/team-member2.jpg" alt="" />
								<h4>AARON TIGER</h4>
								<h5>Designer</h5>
								<ul class="top-social-icons">
									<li><a class="twitter simptip-position-bottom simptip-movable" data-tooltip="twitter" href="#"> </a></li>
							...
							<div class="tm-head-grid">
								<img src="img/index/team-member3.jpg" alt="" />
								<h4>MARK FOX</h4>
								<h5>Developer</h5>
								<ul class="top-social-icons">
									<li><a class="twitter simptip-position-bottom simptip-movable" data-tooltip="twitter" href="#"> </a></li>
...
<!----start-team-members---->
					...
					<div class="wrap"> 
						...
						<div class="fun-head-grids">
							<div class="fun-head-grid">
								<img src="img/index/fact1.png" alt="" />
								<h4>638</h4>
								<h5>CUP OF COFFEE</h5>						
							</div>
							<div class="fun-head-grid">
								<img src="img/index/fact2.png" alt="" />
								<h4>746</h4>
								<h5>HAPPY CLIENTS</h5>					
							</div>
							<div class="fun-head-grid">
								<img src="img/index/fact3.png" alt="" />
								<h4>887</h4>
								<h5>SONG LISTENED</h5>								
							</div>
							<div class="fun-head-grid">
								<img src="img/index/fact4.png" alt="" />
								<h4>1047</h4>
				...
				<div class="blog s3" id="blog">
					<div class="wrap"> 
						...
						<div class="blog-grid">
							<div class="blog-left">
							 	<div class="img-left">
							 		<img src="img/index/blog1.jpg" alt="" />
							 	</div>	
							 	<div class="text-right">
							 		<h6>March 29, 2014</h6>
							 		<h3><a href="#">A NEW INVENTION FOR LOVERS WHO LOVE</a></h3>
							 		<img src="img/index/line.png" alt="" />
							...
							<div class="blog-right">
							 	<div class="img-left">
							 		<img src="img/index/blog2.jpg" alt="" />
							 	</div>	
							 	<div class="text-right">
							 		<h6>March 29, 2014</h6>
							 		<h3><a href="#">A NEW INVENTION FOR LOVERS WHO LOVE</a></h3>
						...
						<div class="blog-grid">
							<div class="blog-left">
							 	<div class="img-left">
							 		<img src="img/index/blog3.jpg" alt="" />
							 	</div>	
							 	<div class="text-right">
							 		<h6>March 29, 2014</h6>
							 		<h3><a href="#">A NEW INVENTION FOR LOVERS WHO LOVE</a></h3>
							...
							<div class="blog-right">
							 	<div class="img-left">
							 		<img src="img/index/blog4.jpg" alt="" />
							 	</div>	
							 	<div class="text-right">
							 		<h6>March 29, 2014</h6>
							 		<h3><a href="#">A NEW INVENTION FOR LOVERS WHO LOVE</a></h3>
						...
						<!---strat-image-cursuals---->
		                  <div class="t-clients">
		                  	<div class="wrap"> 											 
									...
									<li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client1.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client2.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client3.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client4.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client5.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client1.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client2.png"></li><li onClick="location.href='#';" class="nbs-flexisel-item" style="width: 253.6px;"><img src="img/index/client3.png"></li></ul><div class="nbs-flexisel-nav-left" style="top: 21.5px;"></div><div class="nbs-flexisel-nav-right" style="top: 21.5px;"></div></div></div> 
									<div class="clear"> </div>      
								  <!---strat-image-cursuals---->
						...
						<div class="pricing-head">
			   		 	...
			   		 	<div class="pricing-grids">
									<div class="pricing-grid1">	
										...
										<img src="img/index/border.png" alt="" />
										<ul>
														...
														<ul class="payment-type">
															...
															<li>
																<span class="col_checkbox">
																	<input id="4" class="wcss-checkbox2" type="checkbox">
				...
				<!-----logos---->	
		   		 <div class="logos"> 
		   		 	<div class="wrap"> 
			   		 	<ul>
			   		 		<li><img src="img/index/client6.png" alt="" /></li>
			   		 		<li><img src="img/index/client7.png" alt="" /></li>
			   		 		<li><img src="img/index/client8.png" alt="" /></li>
			   		 	</ul>
		   		 	</div>
		   		 </div>
		   		 <!-----cntact---->	
					...
					<div class="wrap">
				        ...
				        <div class="contact_form">
							 	 	    <form method="post" action="contact-post.html">
										    	<span><input type="text" value="NAME" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'NAME';}"><label><img src="img/index/con1.png" alt="" /></label></span>									    
										    	<span class="left"><input type="text" value="EMAIL" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'EMAIL';}"><label><img src="img/index/con2.png" alt="" /></label></span>
										    <div class="clear"></div>
										    	<span><textarea placeholder="MESSAGE"></textarea><label1><img src="img/index/con3.png" alt="" /></label1></span>
		   		  ...
		   		  <div class="signup">
   		              <div class="form">	
							<span><label><img src="img/index/msg.png" alt="" /></label><input type="text" value="Your E-MAIL Please?" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your E-MAIL Please?';}"></span>
				...
				<div class="bottom-footer">
					<div class="wrap"> 
						...
						<div class="bottom-footer-left">
							<p><span>&#169; Copyright 2014 Creativo</span> Template More Templates <a href="http://www.js-css.cn/" title="企业网站模板" target="_blank">企业网站模板</a></p>
						</div>		  
						<div class="clear"> </div>
					</div>
				</div>
